/** Characters used for procedural code generation in the ASCII overlay */
const CODE_CHARS =
...
/**
 * Generates realistic-looking procedural code text to fill the ASCII overlay
 * on each card. The generated text mimics particle/scanner source code.
 */
...
/**
 * Calculate how many characters/rows fit inside a card of given pixel dimensions.
 */
...
/** CDN URLs for the five card face images */

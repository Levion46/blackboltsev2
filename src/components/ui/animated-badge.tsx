...
export const AnimatedBadge = ({
    ...
    const content = (
        <motion.div
            ...
            viewport={{ once: true }}
            className="group relative flex max-w-fit items-center justify-center gap-3 rounded-full border border-white/20 bg-white/5 backdrop-blur-md px-4 py-1.5 text-white/80 transition-colors hover:bg-white/10 cursor-pointer"
        >
            ...
            <ChevronRight className="ml-1 h-3.5 w-3.5 text-white/50 transition-transform duration-200 group-hover:translate-x-0.5" />
        </motion.div>
    )
    return (
        <>

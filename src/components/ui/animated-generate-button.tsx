...
const CSS = `
  ...
  .ui-anim-btn:focus .ui-anim-btn-svg { animation-duration: 1.2s; animation-delay: 0.2s; }
  ...
  .ui-anim-btn:hover { border-color: hsla(var(--highlight-hue), 100%, 80%, 0.4); }
  ...
  .ui-anim-btn:active { border-color: hsla(var(--highlight-hue), 100%, 80%, 0.7); background-color: hsla(var(--highlight-hue), 50%, 20%, 0.5); }
  ...
  .ui-anim-btn:active .ui-anim-letter { text-shadow: 0 0 1px hsla(var(--highlight-hue), 100%, 90%, 0.9); animation: none; }
        ...
        <div className={clsx("relative inline-block", className)} id={id}>
            ...
            <button
                ...
                className={clsx(
                    ...
                    "shadow-[inset_0px_1px_1px_rgba(255,255,255,0.2),inset_0px_2px_2px_rgba(255,255,255,0.15),inset_0px_4px_4px_rgba(255,255,255,0.1),0_-1px_1px_rgba(0,0,0,0.02),0_-2px_2px_rgba(0,0,0,0.03)]",
                    "transition-[box-shadow,border,background-color] duration-400"
                )}
                style={{ ["--highlight-hue" as never]: `${highlightHueDeg}deg` }}
            >
                {/* Sparkle icon */}
                <svg
                    className={clsx(
                ...
                {/* Text */}
                <div className="ui-anim-txt-wrapper relative flex min-w-[6.4em] items-center text-sm font-medium">
                    <div
                        className={clsx(

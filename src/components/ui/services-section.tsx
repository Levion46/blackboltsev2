...
const chatConfig = {
    ...
    messages: [
        ...
        { id: 3, sender: "left" as const, type: "text" as const, content: "It's #BB-20482.", maxWidth: "max-w-[130px]", loader: { enabled: true, delay: 400, duration: 900 } },
        { id: 4, sender: "right" as const, type: "text-with-links" as const, content: "Order #BB-20482 is dispatched and arriving tomorrow by 3 PM! 🎉", maxWidth: "max-w-[210px]", links: [{ text: "Track shipment" }, { text: "Contact support" }], loader: { enabled: true, delay: 400, duration: 1800 } },
    ],
};

const chatUiConfig = {
    containerHeight: 290, backgroundColor: "transparent", autoRestart: true, restartDelay: 3500,
    ...
    <li className={cn("min-h-[14rem] list-none", area)}>
        <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-white/10 p-2 md:rounded-[1.5rem] md:p-3">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-xl border-[0.75px] border-white/10 bg-white/5 backdrop-blur-sm">
                ...
                {chat && (
                    <>
                        <div className="flex-1 min-h-0 mx-2 mt-2 rounded-lg overflow-hidden border border-white/10 bg-black/20 pointer-events-none select-none">
